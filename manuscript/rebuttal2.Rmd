...
Below is our point-by-point response to Reviewer 3's remining comments.
...
Therefore, we have altered the phrase to recognise the journey of bioinformaticians in training.
...
If the reviewer has a specific suggestion, then it would be helpful to provide this.
...
> Headless mode is important for integrating literate scripts into larger workflows and for
> automated testing.
...
We have removed mention of FAIR and we refer readers to the literature on this topic.
...
RESPONSE: Possibly the reviewer hasn't seen the rebuttal letter had it's own bibliography.
Anyway, since "FAIR" is not described anymore, it simplifies the description of these databases,
which satify most best practices. We cite the work of Bonaretti et al 2019.
