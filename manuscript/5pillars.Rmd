...
@Rodrigues2023-fw; @DuPre2022-bk; @Krafczyk2021-xv; @Stodden2016-aj].
...
Researchers face several hurdles in adopting these.

* The "publish-or-perish" incentive structures in academia reward prolific rather than scrupulous
authors.
Funding bodies, institutions and journals generally prefer to focus on novel research directions rather
than meticulous confirmation of previous findings [@Garijo2013-zl ; @Huang2013-xr; @Kaelin2017-id;
@Munafo2017-ty; @Diong2021-is].

* A lack of systematic reproducibility/replication studies in bioinformatics remains small
[@Ioannidis2009-hv; @Zaringhalam2020-ms; @Samuel2022-ha], so the severity of the reproducibility
problem isn't well appreciated.

* Journal standards are slow to progress.
Our observations indicate that sharing of data and code remains optional for most medical
journals in PubMed, but in the field of computational biology, providing these resources is
becoming standard practice.

* A lack of documentated protocols and tutorial materials for highly-reproducible analysis makes it
difficult for researchers to confidently update their code development practices.

* An overall lack of coding/data science expertise among life science researchers and new graduates.
Due to strong demand from industry and government, academia has a deficit of workers fluent in data
science [@Committee_on_Envisioning_the_Data_Science_Discipline_The_Undergraduate_Perspective2018-pe].
This makes it challenging for organisations to recruit capable data analysts and cultivate a
community of practice.

Stodden et al have outlined some practical recommendations for tackling these problems [@Stodden2016-aj].

Overcoming these obstacles will require a multi-pronged strategy and effort from different stakeholders.

* What researchers can do.

* What journals can do.

* What insitutions can do.

* What universities can do.

* What funders can do.

* Incentive structures will need to change.
How we measure and value research achievement.
A change in culture or research assessment.
How we fund research data analytics and infrastructure.
Value rigour as well as prolificness.

* Journals need to progress towards publishing reproducible workflows.
Peng 2011 speaks about the lack of infrastructure for disseminating reproducible research.
...
[@Wilson2014-mh].
Undergraduate and postgraduate courses in the life sciences would benefit from enhanced training in data
science.

* Enhanced documentation, protocols and tutorials.
The most scalable solution would be to provide comprehensive beginner-friendly step-by-step
...
Recognition that life sciences is a data intensive discipline.
