...
The intended audience is anyone who analyzes biological data (not tool developers), however the
...
For a bioinformatics project to be reproducible, it needs to be formalised in code and include all
...
The studies that have been conducted point to reproducibility rates of ~10% in computational
life sciences [@Ioannidis2009-hv;@Zaringhalam2020-ms; @Samuel2022-ha], but further systematic studies
are required to bring attention to the issue.

Journals are partly responsible, as their editorial policies influence author behaviours.
Except for a few outliers, verification of computational reproducibility is not in the scope of peer
review, but this should be considered.
...
metrics and number of publications rather than the rigour [@Munafo2017-gf].
A change in research assessment ("eg: track-record") that recognises and credits contributions toward
...
This makes it challenging for organisations to recruit and retain capable data analysts and cultivate
a community of practice.
Addressing this problem is not straightforward.
It requires ehancement of data science skills in undergraduate life science courses, investment in
upskilling the current workforce and offering working conditions that are competitive with other sectors.
