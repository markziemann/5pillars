...
```{r,5pillars,fig.cap="Figure 1. The five pillars of computational reproducibility.",echo=FALSE,fig.height=5}
...
plot(0,type='n',axes=FALSE,ann=FALSE, xlim=c(0, 10), ylim=c(0, 9))
...
text(5,9,lab="Five pillars of reproducible computational research", cex=1.5)
...
text(5,7,lab="Code testing",cex=1.2)
...
```{r,dvcs,fig.cap="Figure 3. Distributed version control. Adapted from @Chacon2014-ys.",echo=FALSE,fig.height=8}
...
plot(0,type='n',axes=FALSE,ann=FALSE, xlim=c(0, 10), ylim=c(-5, 8.5))
...
grid.raster(mypng, x=.55, y=.2, width=0.85)
...
While deidentification of data has been widely used to safeguard participant privacy, this may not
...
frameworks designed to protect personal data in a way that perserves reproducibility
...
High throughput biology has already built a number of data repositories for specific data types mostly
conforming to FAIR principles.
Repositories like GEO, SRA, ENA and PRIDE were developed in the aftermath of the draft human
genome assembly and have become well known to omics researchers
[@Edgar2002-hs; @Kodama2012-bn; Martens2005-wo]).
