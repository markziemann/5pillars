...
A noteworthy attempt to use litterate programming in Jupyter notebooks to aim for reproducibility 
...
To this aime, general recommendations have been proposed to enhance data FAIRness in ecology, but which
...
[@Zaringhalam2020-ms ; @Ioannidis2009-hv; @Samuel2022-ha], so the severity of the problem isn't
well understood.
...
* Irreproducibility of bioinformatics studies remains a significant problem.
...
Research directions include proteomics, bioinformatics and education/pedagogy.
