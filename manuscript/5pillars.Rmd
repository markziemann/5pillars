...
study.
This automated process removes the need for any manual steps, which are not only time-consuming but
...
as opposed to proprietary software like SPSS, STATA and MatLab which are cost inhibitory.
...
code to consumers.
There are many such DVCSs (subversion, git, bazaar, mercurial...), but `git` has emerged as the most popular
...
[Software Heritage](https://www.softwareheritage.org/) @dicosmo2017 is the universal software archive 
...
in the respective journal article/preprint. The archival of the source code in Software Heritage
can be performed manually or automated by a webhook within a continuous integration.
...
bit-for-bit build reproducibility and verifiability [@Vallet2022-no; @Courtes2022-rx].
...
their reproducibility [@Simoneau2021-kp].
...
[@Huang2013-xr; @Kaelin2017-id; @Munafo2017-ty; @Diong2021-is].
...
Our recommendations for workflow-based research articles are summarized as:
...
**Samuel S. Minot** works as a Staff Scientist at Fred Hutchinson Cancer Center within the Vaccine and
Infectious Disease Division.
His research is focused on human microbiota associations with human health and disease.
...
Her research project involves improving the rigor of commonly used bioinformatics tools.
