...
Mark Ziemann<sup>1*</sup>, Pierre Poulain<sup>2</sup>, Anusuiya Bora<sup>1</sup>
...
In this work, authors provided along the traditionnal research paper a 
...
[Software Heritage](https://www.softwareheritage.org/) [@dicosmo2017; abramatic2018] is the universal software archive
whose mission is to collect, preserve and share source code. Software Heritage provides
an intrinsic persistent identifier called SWHID that allows to cite the archived source code
in the respective journal article/preprint [@cosmo2020]. The archival of the source code in Software Heritage
can be performed [manually](https://archive.softwareheritage.org/save/)
or automated by a [webhook](https://docs.softwareheritage.org/user/save_code_now/webhooks/index.html)
...
#border
polygon(c(0,12,12,0),c(0,0,8,8),border="gray")
...
Our recommendations for computational researchers are summarized as:

0. Encapsulate the entire workflow in an end-to-end automated process, executable with a master script.
...
* Widespread adoption of these principles will enhance research reliability and speed translation of
