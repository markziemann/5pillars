...
@Stodden2016-aj; @Beaulieu-Jones2017-vj; @Gruning2018-sg; @Akalin2018-eg;
...
text(5,7,lab="Process validation & testing",cex=1.2)
...
[@Cadwallader2022-od] with integrated version control.
...
[@Kurtzer2017-zq], Docker remains the most widely used containerisation system (according to GitHub
...
license.
A recently described set of recommendations for making software FAIR describes further measures
...
[@Rule2019-eh; @The_Turing_Way_Community2019-ig; @Noor2022-uc].
...
If the workflow executes successfully and tests are passed, the repository and linked research article
can be decorated with a "badge" to inform users of the lack of errors in the code,
...
Journals are partly responsible, as their editorial policies influence author behaviours [@Han2017-pz].
...
If adopted widely, the transparency and reproducibilty measures proposed here will reduce the chance of
