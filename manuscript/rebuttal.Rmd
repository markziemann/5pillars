...
* Recommendations
  ...
  * Process validation & code testing
...
> frameworks designed to protect personal data in a way that perserves reproducibility [@Rehm2021-kt;@Thorogood2021-kt].
...
In line with this, the passage been amended:
...
refered readers to dedicated reviews on the topic.
...
challenges that are holding back change.
